        ...
        (() => {
            ...
            function m(t, e) {
                ...
                return (
                    y(t)
                        ...
                        : "string" == typeof t && ((s = `String data of length ${t.length}`), e && (s += `. Content: '${t}'`)),
                    s
                );
            }
            function y(t) {
            ...
            async function b(t, s, i, n, r, o) {
                ...
                const l = y(r) ? "arraybuffer" : "text",
                    u = await i.post(n, { content: r, headers: { ...h, ...o.headers }, responseType: l, timeout: o.timeout, withCredentials: o.withCredentials });
            ...
            class N {
                ...
                et(t) {
                    return this.M === A.Disconnected
                        ...
                        : ((this.M = A.Disconnecting),
                          ...
                          this.st
                              ? (this.u.log(e.Debug, "Connection stopped during reconnect delay. Done reconnecting."), clearTimeout(this.st), (this.st = void 0), this.it(), Promise.resolve())
                              : (this.G(), this.Z(), (this.B = t || new r("The connection was stopped before the hub handshake could complete.")), this.connection.stop(t)));
                }
                stream(t, ...e) {
                    const [s, i] = this.nt(e),
                        n = this.rt(t, e, i);
                ...
                async dt(t) {
                    ...
                    if (!i)
                        return (
                            this.u.log(e.Warning, `No client method with the name '${s}' found.`),
                            void (t.invocationId && (this.u.log(e.Warning, `No result given for '${s}' method and invocation ID '${t.invocationId}'.`), await this.ht(this.gt(t.invocationId, "Client didn't provide a result.", null))))
                        );
                    const n = i.slice(),
                        r = !!t.invocationId;
                    let o, h, c;
                    for (const i of n)
                        try {
                            ...
                            (o = await i.apply(this, t.arguments)),
                                r && o && n && (this.u.log(e.Error, `Multiple results provided for '${s}'. Sending error to server.`), (c = this.gt(t.invocationId, "Client provided multiple results.", null))),
                                (h = void 0);
                        } catch (t) {
                    ...
                    c
                        ...
                        ? (h
                              ...
                              : (this.u.log(e.Warning, `No result given for '${s}' method and invocation ID '${t.invocationId}'.`), (c = this.gt(t.invocationId, "Client didn't provide a result.", null))),
                          await this.ht(c))
                        : o && this.u.log(e.Error, `Result given for '${s}' method but server is not expecting a result.`);
                }
                _(t) {
                    this.u.log(e.Debug, `HubConnection.connectionClosed(${t}) called while in state ${this.M}.`),
                        (this.B = this.B || t || new r("The underlying connection was closed before the hub handshake could complete.")),
                        this.X && this.X(),
                        this.yt(t || new Error("Invocation canceled due to the underlying connection being closed.")),
                        this.G(),
                        this.Z(),
                        this.M === A.Disconnecting ? this.it(t) : this.M === A.Connected && this.P ? this.bt(t) : this.M === A.Connected && this.it(t);
                }
                it(t) {
                    if (this.j) {
                ...
                async bt(t) {
                    ...
                    for (; null !== r; ) {
                        if (
                            (this.u.log(e.Information, `Reconnect attempt number ${i} will start in ${r} ms.`),
                            await new Promise((t) => {
                ...
                lt(t, e, s, i) {
                    if (s) return 0 !== i.length ? { arguments: e, streamIds: i, target: t, type: R.Invocation } : { arguments: e, target: t, type: R.Invocation };
                    {
                        const s = this.N;
                ...
                rt(t, e, s) {
                    const i = this.N;
                    return this.N++, 0 !== s.length ? { arguments: e, invocationId: i.toString(), streamIds: s, target: t, type: R.StreamInvocation } : { arguments: e, invocationId: i.toString(), target: t, type: R.StreamInvocation };
                }
                ot(t) {
            ...
            class B {
                ...
                async connect(t, s) {
                    ...
                    200 !== a.statusCode ? (this.u.log(e.Error, `(LongPolling transport) Unexpected response code: ${a.statusCode}.`), (this.Rt = new i(a.statusText || "", a.statusCode)), (this.Dt = !1)) : (this.Dt = !0),
                    ...
                    try {
                        for (; this.Dt; )
                            try {
                                ...
                                204 === r.statusCode
                                    ? (this.u.log(e.Information, "(LongPolling transport) Poll terminated by server."), (this.Dt = !1))
                                    : 200 !== r.statusCode
                                    ? (this.u.log(e.Error, `(LongPolling transport) Unexpected response code: ${r.statusCode}.`), (this.Rt = new i(r.statusText || "", r.statusCode)), (this.Dt = !1))
                                    : r.content
                                    ? (this.u.log(e.Trace, `(LongPolling transport) data received. ${m(r.content, this.Ht.logMessageContent)}.`), this.onreceive && this.onreceive(r.content))
            ...
            class X {
                ...
                async connect(t, s) {
                    return (
                        ...
                        (this.xt = t),
                        this.Pt && (t += (t.indexOf("?") < 0 ? "?" : "&") + `access_token=${encodeURIComponent(this.Pt)}`),
                        new Promise((i, n) => {
                            let r,
                                o = !1;
                            if (s === O.Text) {
                                if (g.isBrowser || g.isWebWorker) r = new this.Ht.EventSource(t, { withCredentials: this.Ht.withCredentials });
                                else {
            ...
            class J {
                    ...
                    return (
                        ...
                        new Promise((n, r) => {
                            ...
                            o || (o = new this.qt(t)),
                                ...
                                (o.onmessage = (t) => {
                                    if ((this.u.log(e.Trace, `(WebSockets transport) data received. ${m(t.data, this.jt)}.`), this.onreceive))
                                        try {
                ...
                send(t) {
                    return this.Ot && this.Ot.readyState === this.qt.OPEN
                        ? (this.u.log(e.Trace, `(WebSockets transport) sending data. ${m(t, this.jt)}.`), this.Ot.send(t), Promise.resolve())
                ...
                Lt(t) {
                    this.Ot && ((this.Ot.onclose = () => {}), (this.Ot.onmessage = () => {}), (this.Ot.onerror = () => {}), this.Ot.close(), (this.Ot = void 0)),
            ...
            class z {
                constructor(t, s = {}) {
                    ...
                    if (
                        ...
                        (this.Xt = 1),
                        w.isRequired(t, "url"),
                        (this.u = void 0 === (i = s.logger) ? new $(e.Information) : null === i ? p.instance : void 0 !== i.log ? i : new $(i)),
                    ...
                    g.isNode || "undefined" == typeof WebSocket || s.WebSocket ? g.isNode && !s.WebSocket && n && (s.WebSocket = n) : (s.WebSocket = WebSocket),
                        ...
                        (this.$ = new q(s.httpClient || new H(this.u), s.accessTokenFactory)),
                        (this.M = "Disconnected"),
                        (this.j = !1),
                        (this.Ht = s),
                        (this.onreceive = null),
                ...
                async start(t) {
                    if (((t = t || O.Binary), w.isIn(t, O, "transferFormat"), this.u.log(e.Debug, `Starting connection with transfer format '${O[t]}'.`), "Disconnected" !== this.M))
                ...
                async te(t, s, i, n) {
                    ...
                    return h.length > 0
                        ? Promise.reject(new l(`Unable to connect to the server with any of the available transports. ${h.join(" ")}`, h))
                ...
                ne(t, s, i) {
                    ...
                    if (
                        ...
                        return this.u.log(e.Debug, `Skipping transport '${W[n]}' because it was disabled by the client.`), new h(`'${W[n]}' is disabled by the client.`, n);
                    if (!(t.transferFormats.map((t) => O[t]).indexOf(i) >= 0))
                        return this.u.log(e.Debug, `Skipping transport '${W[n]}' because it does not support the requested transfer format '${O[i]}'.`), new Error(`'${W[n]}' does not support ${O[i]}.`);
                    if ((n === W.WebSockets && !this.Ht.WebSocket) || (n === W.ServerSentEvents && !this.Ht.EventSource))
                        return this.u.log(e.Debug, `Skipping transport '${W[n]}' because it is not supported in your environment.'`), new o(`'${W[n]}' is not supported in your environment.`, n);
            ...
            const Q = { trace: e.Trace, debug: e.Debug, info: e.Information, information: e.Information, warn: e.Warning, warning: e.Warning, error: e.Error, critical: e.Critical, none: e.None };
            class Y {
                configureLogging(t) {
                ...
                withUrl(t, e) {
                    return (
                        w.isRequired(t, "url"), w.isNotEmpty(t, "url"), (this.url = t), (this.httpConnectionOptions = "object" == typeof e ? { ...this.httpConnectionOptions, ...e } : { ...this.httpConnectionOptions, transport: e }), this
                    );
                }
                withHubProtocol(t) {
