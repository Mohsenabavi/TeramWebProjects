...
namespace Teram.QC.Module.FinalProduct.Migrations
{
    ...
    [Migration("20241212163507_addNeedToCheckByOperationManager")]
    partial class addNeedToCheckByOperationManager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Teram.QC.Module.FinalProduct.Entities.Causation.Causation", b =>
                {
                    ...
                    b.Property<bool?>("FailureToFollowInstructions")
                        .HasColumnType("bit");

                    b.Property<int?>("FailureToIdentifyId")
                        .HasColumnType("int");

                    b.Property<int?>("FailureToIdentifyId2")
                        .HasColumnType("int");

                    b.Property<int?>("FailureToIdentifyId3")
                        .HasColumnType("int");

                    b.Property<int>("FinalProductNoncomplianceId")
                        .HasColumnType("int");

                    b.Property<int?>("HasConcessionarylicenseForRawMaterials")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsIdentifiableInProduction")
                        .HasColumnType("bit");

                    b.Property<bool>("IsIdentifiableRawMaterialDefcets")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("MachineryCauseId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("WrongDoerInspectorId")
                        .HasColumnType("int");

                    b.Property<int>("WrongdoerId")
                        .HasColumnType("int");

                    b.Property<int>("WrongdoerId2")
                        .HasColumnType("int");

                    b.Property<int>("WrongdoerId3")
                        .HasColumnType("int");

                    b.Property<int>("WrongdoerId4")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Teram.QC.Module.FinalProduct.Entities.Causation.MachineryCause", b =>
                {
                    b.Property<int>("MachineryCauseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MachineryCauseId"));

                    b.Property<string>("Title")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MachineryCauseId");

                    b.ToTable("MachineryCause");
                });
            ...
            modelBuilder.Entity("Teram.QC.Module.FinalProduct.Entities.Causation.RawMaterial", b =>
                {
                    b.Property<int>("RawMaterialId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Teram.QC.Module.FinalProduct.Entities.FinalProductNoncompliance", b =>
                {
                    ...
                    b.Property<Guid?>("DestinationUser")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("FinalApproveByQA")
                        .HasColumnType("bit");

                    b.Property<DateTime>("FinalApproveByQADate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("IsTriggeredByUserAction")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("NeedToCheckByOperationManager")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Teram.QC.Module.FinalProduct.Entities.Causation.Causation", b =>
                {
                    ...
                    b.HasOne("Teram.QC.Module.FinalProduct.Entities.Causation.MachineryCause", "MachineryCause")
                        .WithMany()
                        .HasForeignKey("MachineryCauseId");

                    b.HasOne("Teram.QC.Module.FinalProduct.Entities.Causation.Operator", "Operator")
                        .WithMany("Causations")
                        .HasForeignKey("OperatorId");

                    b.HasOne("Teram.QC.Module.FinalProduct.Entities.Causation.RawMaterial", "RawMaterial")
                        .WithMany("Causations")
