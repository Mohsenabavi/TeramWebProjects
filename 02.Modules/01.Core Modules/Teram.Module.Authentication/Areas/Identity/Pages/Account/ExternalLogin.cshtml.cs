...
namespace Teram.Module.Authentication.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            SignInManager<TeramUser> signInManager,
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new TeramUser { UserName = Input.Email, Email = Input.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        //{
                        //    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email", htmlTemplateParser.Parse("Email", "EmailConfirmation", CultureInfo.CurrentUICulture, values.ToArray()));
