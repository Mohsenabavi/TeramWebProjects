...
(function ($) {
    ...
    $.fn.fileinputLocales['fa'] = {
        ...
        removeLabel: 'حذف',
        removeTitle: 'پاکسازی فایل‌های ترام چاپ شده',
        cancelLabel: 'لغو',
        cancelTitle: 'لغو بارگزاری جاری',
        pauseLabel: 'Pause',
        pauseTitle: 'Pause ongoing upload',
        uploadLabel: 'بارگذاری',
        uploadTitle: 'بارگذاری فایل‌های ترام چاپ شده',
        msgNo: 'نه',
        msgNoFilesSelected: 'هیچ فایلی ترام چاپ نشده است',
        msgPaused: 'Paused',
        msgCancelled: 'لغو شد',
        msgPlaceholder: 'ترام چاپ {files} ...',
        msgZoomModalHeading: 'نمایش با جزییات',
        msgFileRequired: 'شما باید یک فایل برای بارگذاری ترام چاپ نمایید.',
        ...
        msgFilesTooLess: 'شما باید حداقل <b>{n}</b> {files} فایل برای بارگذاری ترام چاپ کنید.',
        msgFilesTooMany: 'تعداد فایل‌های ترام چاپ شده برای بارگذاری <b>({n})</b> از حداکثر مجاز عبور کرده است <b>{m}</b>.',
        ...
        msgSelected: '{n} {files} ترام چاپ شده',
        ...
        dropZoneClickTitle: '<br>(یا برای ترام چاپ {files} کلیک کنید)',
        fileActionSettings: {
