...
namespace Teram.HR.Module.Recruitment.Migrations
{
    ...
    [Migration("20240107125747_AddFileNameAndExtensionToHSEFiles")]
    partial class AddFileNameAndExtensionToHSEFiles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Teram.HR.Module.Recruitment.Entities.JobApplicants.JobApplicant", b =>
                {
                    ...
                    b.Property<string>("FileSummaryFileExtension")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FileSummaryFileName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("FileSummmaryAttachmentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ReferralFileExtension")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReferralFileName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
